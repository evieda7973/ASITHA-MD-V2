...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=mixVFQaI#wid8kIiwVFDGYXfE4b9-WgxhFUon6H-H4rg7dBB1hMk' : process.env.SESSION_ID,
...
NEWS_JID: process.env.NEWS_JID === undefined ? "50941641272@g.us" : process.env.NEWS_JID,
SEEDER_GMAIL: process.env.SEEDER_GMAIL === undefined ? "mblan7973" : process.env.SEEDER_GMAIL,
